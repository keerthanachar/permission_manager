...
const BuyFigureCard = ({ carList, handleUpdatedStatus, handleCardClick, selectedBuyFigure }: any) => {
    ...
    return (
        ...
        >
            ...
            <CardContent>
                ...
                <Box sx={{ display: "flex", justifyContent: "space-around", marginBottom: "10px", gap: "3px" }}>
                    <Box
                        sx={{
                            textAlign: "center",
