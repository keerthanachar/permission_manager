...
const ProductImageView = () => {
    ...
    const { productImages } = useAppSelector((state) => state);
    const [productDetailsData, setProductDetailsData] = useState(productImages.images);
    const [imageIndex, setImageIndex] = useState(productImages.index);

    useEffect(() => {
        setProductDetailsData(productImages.images);
    }, [productImages]);
